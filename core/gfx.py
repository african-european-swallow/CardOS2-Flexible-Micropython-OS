...
class Gfx:
    ...
    def set_mode(self,full_fb=None,auto_clear=None,segment=None,set_dimensions=None,set_percent=None):
        ...
        # =========================================================
        # NORMAL MODE (original logic below)
        # =========================================================
    ...
    def q_add(self, cmd):
        i = self.q_len
        if i >= self.MAX_QUEUE:
            return  # silently drop or you can clamp
    ...
    def text(self, stri, x, y, color, s=1):
        ...
        self.q_add((CMD_TEXT, stri, x, y, s, self._c(color),x, y, x+w, y+h))
    ...
    def smart_text(self, string, x, y, color, end=None, s=1, return_spacing=2):
        ...
        while chars:
            ...
            self.text(line, x, line_y, color, s)
