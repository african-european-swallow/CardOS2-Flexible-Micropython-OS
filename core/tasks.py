def get_text(cos,prompt='',current=''):
    ...
    if "keyboard" in available:
        ...
        cos.input.claim_caps('dpad')
        mode = 3
    else:
        cos.gfx.fill((0, 0, 0))
        cos.gfx.text("NO INPUT", 0, 0, (255, 0, 0))
        cos.gfx.draw()
    ...
    while True:
        ...
        # =========================
        # MODE 2 (touchpad + dpad + CAPS/SHIFT)
        # =========================
        elif mode == 2:
        ...
        # =========================
        # MODE 3 (dpad only + same modifiers)
        # =========================
        elif mode == 3:
            dpad = cos.input.get_pressed_cap("dpad")
        ...
        # text output
        cos.gfx.smart_text(prompt+content, 0, 0, (0, 255, 0))
        ...
        cos.gfx.text(mod_text, 0, 10, (255, 255, 0))
        ...
        for i, k in enumerate(keys):
            ...
            cos.gfx.text(display_key(k), x, y, color)
